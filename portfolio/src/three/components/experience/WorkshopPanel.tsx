...
export function WorkshopPanel({
  ...
  return (
    <aside
      ...
      className="border-scene-line bg-scene-ink/92 pointer-events-auto flex max-h-[58dvh] w-full flex-col rounded-2xl border backdrop-blur-md sm:max-h-[66dvh] sm:w-[26rem]"
    >
      <header className="border-scene-line flex items-center justify-between border-b px-5 py-4">
